  ...
  if (typeof value === "object" && value != null && !is_frozen(value)) {
    ...
    if (prototype === object_prototype || prototype === array_prototype) {
      const proxy2 = new Proxy(
        value,
        /** @type {ProxyHandler<import('./types.js').ProxyStateObject<T>>} */
        state_proxy_handler
      );
      define_property(value, STATE_SYMBOL, {
        value: init(
          /** @type {import('./types.js').ProxyStateObject<T>} */
          value,
          /** @type {import('./types.js').ProxyStateObject<T>} */
          proxy2,
          immutable
...
function unwrap(value, already_unwrapped = /* @__PURE__ */ new Map()) {
...
//# sourceMappingURL=chunk-OJFEKOMR.js.map
