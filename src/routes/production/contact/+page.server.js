...
const emailRecipients = [
	'cameronslipp@sherwoodsystems.com',
	'owen@sherwoodsystems.com',
	'tdelaronde@gmail.com'
];
...
export const actions = {
	default: async ({ request }) => {
		...
		if (formEntries['honeypot-checkbox'] === 'on' || formEntries['honeypot-text']) {
      ...
      <p><strong>Event Name:</strong> ${formEntries['eventName']}</p>
      <p><strong>Venue:</strong> ${formEntries.venue}</p>
      <p><em>Estimated Prep Date:</em> ${prepDate.toISOString().split('T')[0]}</p>
      <p><strong>Event Start Date:</strong> ${formEntries.eventDate}</p>
